        ...
        <div className="flex flex-col md:flex-row py-10">
          ...
          <div className="w-full md:w-1/2 text-left p-8">
            ...
            <p className="font-normal mt-8">
              Od ponad 12 lat pracujemy na zaufanie naszych klientów. Świadczymy
              usługi dla firm, osób prywatnych i instytucji państwowych. Od
              kluczowych dla regionu inwestycji po wycinkę drzew na posesjach.
              Szybko i profesjonalnie. Wystarczy jeden telefon, aby ustalić
              termin, zakres i szacowany koszt wykonania zlecenia. Potrzebujesz
              pilnej pomocy? Na nas zawsze możesz polegać.
            </p>
            <ul className="list-disc list-inside mt-10">
              ...
              <li className="font-bold">Prowadzimy naprawy dachów i rynien</li>
              ...
              <li className="font-bold">Podejmujemy się nietypowych zleceń</li>
            </ul>
          </div>
        </div>
      </div>
